# Page Composer documentation

- [Getting started](getting-started.md): install, write a config, mount the editor, render the page.
- [Configuration and field types](configuration.md): every config option and field type.
- [Data binding](data-binding.md): `$bind` expressions, the resolver, and supplying data.
